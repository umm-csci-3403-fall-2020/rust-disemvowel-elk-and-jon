...
fn main() {
    ...
    write_file(&outfile, &s_disemvowel);
}
...
fn disemvowel(s: &str) -> String {
    let d = String::from(s);
    let ds: Vec<char> = d.chars().collect();
